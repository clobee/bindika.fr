            ...
            <VerticalTimeline>
                ...
                >
                    ...
                    <p>
                        ...
                        I am currently working remote on a <span className="badge badge-dark">Drupal 8</span> <span className="badge badge-dark">ReactJS</span> <u>membership platform</u> with <u>E-commerce
                        functionalities</u>.
                    </p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                ...
                >
                    ...
                    <p>
                        Rebuilt & developed new features for the company whole applications/websites in PHP <span className="badge badge-dark">Drupal</span> <span className="badge badge-dark">Symfony</span>.
                ...
                >
                    ...
                    <p>
                        ...
                        <span className="badge badge-dark">Drupal</span> <span className="badge badge-dark">Symfony</span>. My team has ownership of all digital deliveries (maintenance and innovation).
                        <br/><br/>
                        ...
                        <br/><br/>
                        Main architect of the <u>continuous integration</u> system involving <span className="badge badge-light">Jenkins</span> <span className="badge badge-light">Phing</span> <span className="badge badge-light">Jira</span> <span className="badge badge-light">Github</span>
                ...
                >
                    ...
                    <p>
                        ...
                        basis).
                        <u>Building & maintaining</u> numerous websites <span className="badge badge-dark">Wordpress</span> and mainly the main application <span className="badge badge-dark">Symfony</span>.
                        <br/><br/>
                ...
                >
                    ...
                    <p>
                        ...
                        Software development using <span className="badge badge-dark">Zend 1/2</span> & <span className="badge badge-dark">Backbone.js</span> + Scripting <span className="badge badge-dark">Perl</span> <span className="badge badge-dark">Bash</span>
                        <br/><br/>
                        <b>Main achievement(s):</b> Lead developer of an <u>headless back office application</u> (build with
                ...
                >
                    ...
                    <p>
                        ...
                        Dedicated to the French market, providing the <u>technical support</u> to various stakeholders to
                        ensure that Broadbean's products are correctly integrated with the client's infrastructure.
                        <br/><br/>
                        <b>Main achievement(s):</b> Creation of a <u>set of scripts</u> automating the workflow for the french
                        market.
                    </p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                ...
                >
                    ...
                    <p>
                        Trained developers on using and maintaining the <span className="badge badge-dark">Prestashop</span> system (previously created and
                        ...
                        The contract was completed through the creation of a new multi site <u>E-commerce platform</u> <span className="badge badge-light">Prestashop</span> fully integrated with the company's intranet/websites <span className="badge badge-light">CRM</span> <span className="badge badge-light">Custom
                        system</span> <span className="badge badge-light">CMSmadesimple</span> <span className="badge badge-light">Drupal</span> <span className="badge badge-light">Wordpress</span>.
                    </p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                    className="vertical-timeline-element--work"
                ...
                >
                    ...
                    <p>
                        ...
                        During the first year, I mainly worked as an HTML/CSS integrator and a <span className="badge badge-dark">PHP</span> developer.
                        In the second year, my responsibilities included project management and further technologies <span className="badge badge-light">Actionscript</span> <span className="badge badge-light">AJAX</span> <span className="badge badge-light">JAVA</span>.

                        In my final year, I was responsible for the creation and maintenance of many websites in <span className="badge badge-dark">Wordpress</span> & <span className="badge badge-light">Drupal</span> alongside my role in the main website of the company <span className="badge badge-dark">Drupal 6</span>: a high
